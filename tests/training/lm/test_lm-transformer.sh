...
$MRT_TOOLS/diff-floats.py $(pwd)/lm-transformer.out $(pwd)/lm-transformer.expected -p 0.02 | tee $(pwd)/lm-transformer.diff | head
...
$MRT_TOOLS/diff-floats.py $(pwd)/lm-transformer.scores.out $(pwd)/lm-transformer.scores.expected -p 0.002 | tee $(pwd)/lm-transformer.scores.diff | head
