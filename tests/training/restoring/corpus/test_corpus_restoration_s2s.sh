...
extra_opts="--seed 1111 --maxi-batch 1 --maxi-batch-sort none --mini-batch 32 -o sgd --dim-emb 128 --dim-rnn 256 --disp-freq 4 --type s2s"
...
$MRT_TOOLS/diff-floats.py $(pwd)/corpus_s2s.out $(pwd)/corpus_s2s.expected -p 0.1 | tee $(pwd)/corpus_s2s.diff | head
