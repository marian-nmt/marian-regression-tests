...
$MRT_TOOLS/diff-floats.py -p 0.001  adam_sync.mt.out adam_sync.mt.expected > adam_sync.mt.diff
$MRT_TOOLS/diff-floats.py -p 0.0001 adam_sync.vt.out adam_sync.vt.expected > adam_sync.vt.diff
