...
$MRT_MARIAN/build/marian \
    ...
    -m adagrad/model.npz -t $MRT_DATA/europarl.de-en/corpus.bpe.{en,de} -v vocab.{en,de}.yml \
...
$MRT_TOOLS/diff-floats.py -p 0.0001  adagrad.gt.out adagrad.gt.expected > adagrad.gt.diff
