...
python $MRT_MARIAN/scripts/contrib/model_info.py -m adam/model.npz.optimizer.npz -k "adam_mt" | tr '\n' ' ' > adam.mt.out
$MRT_TOOLS/diff-floats.py --numpy -p 0.0001  adam.mt.out adam.mt.expected > adam.mt.diff
python $MRT_MARIAN/scripts/contrib/model_info.py -m adam/model.npz.optimizer.npz -k "adam_vt" | tr '\n' ' ' > adam.vt.out
